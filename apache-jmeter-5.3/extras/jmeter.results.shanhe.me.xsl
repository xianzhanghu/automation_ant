...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/testResults">
        ...
        <head>
            ...
            <style type="text/css"><![CDATA[
                ...
                * { margin: 0; padding: 0 }
                ...
                #left-panel .el-button { display: inline-block;line-height: 1;white-space: nowrap;cursor: pointer;-webkit-appearance: none;text-align: center;-webkit-box-sizing: border-box;box-sizing: border-box;outline: 0;margin: 0;-webkit-transition: .1s;transition: .1s;font-weight: 500;padding: 6px 15px;font-size: 14px;border-radius: 4px;background: #3a8ee6;border-color: #3a8ee6;color: white;margin: 3px; }
            ...
            <script type="text/javascript"><![CDATA[
                ...
                var onclick_a = (function() {
                    return function() {
                        var getHtmlDocName = function() {
                            var str = window.location.href;
                            str = str.substring(str.lastIndexOf("/") + 1);
                            str = str.substring(0, str.lastIndexOf("."));
                            return str;
                        };
                        var url = "./interface_test_summary_report_" + getHtmlDocName().split('_')[getHtmlDocName().split('_').length-1] + ".html";
                ...
                window.onload = function() {
                    ...
                    if (location.search.split('?label=').length > 0) {
                        var a = document.getElementsByName(decodeURI(window.location.search.split('?label=')[1]))[0];
                        if (a) onclick_li(a);
                    } else {
                        if(o) onclick_li(o);
                    }
        ...
        <body>
            <div id="left-panel">
                <a id="link" class="el-button" href="javascript:void(0)" onclick="return onclick_a();">返回</a>
                <ol id="result-list">
                    <xsl:for-each select="*">
                        ...
                        <li onclick="return onclick_li(this);" name="{@lb}">
                            <div>
